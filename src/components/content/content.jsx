...
const Content = () => {
    ...
    const listenToScroll = (e) => {
        ...
        setArcOffset2(Math.abs(
            arcLength * (1 - (e.target.scrollTop / (scrollHeight - clientHeight)))
        ));
    }
    ...
    React.useEffect(() => {
        ...
        scrolling.addEventListener('scroll', listenToScroll);

        return () => { scrolling.removeEventListener('scroll', listenToScroll); };
    })


    return (
        <div id='scrolling' className={s.container}>
